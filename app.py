...
if uploaded_file is not None:
    ...
    if selected_model == "Transfer Learning - Xception":
        model = load_xception_model('Models/trained_xception_model.weights.h5')
        img_size = (299, 299)
    elif selected_model == "Custom CNN":
        model = load_model('Models/cnn_model.h5')
        img_size = (150, 150)
    elif selected_model == "VGG16":
        model = load_vgg16_model('Models/vgg16_model.h5')
        img_size = (150, 150)  # Make sure your model was trained with this size
    else:  # ResNet101
        model = load_resnet_model('Models/resnet101_model.h5')
        img_size = (150, 150)  # Make sure your model was trained with this size
